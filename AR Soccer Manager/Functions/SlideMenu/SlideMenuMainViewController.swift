...
public protocol SlideMenuDelegate: AnyObject {
...
open class SlideMenuMainViewController: UIViewController {
	...
	open var animationOptions: SlidingAnimationOptions = [.slidingMenu, .dimmedBackground, .menuShadow, .blurBackground]
    ...
    private var _animator:SlidingAnimatorProtocol?
    var animator: SlidingAnimatorProtocol {
        if _animator == nil {
            _animator = SlidingAnimatorFactory.animator(options: animationOptions, duration: animationDuration)
        }
        return _animator!
    }
    ...
    override open func viewDidLoad() {
		...
		NotificationCenter.default.addObserver(self,
											   selector: #selector(SlideMenuMainViewController.handleShowLeftMenuNote),
											   name: .showLeftMenu,
											   object: nil)
		NotificationCenter.default.addObserver(self,
											   selector: #selector(SlideMenuMainViewController.handleShowRightMenuNote),
											   name: .showRightMenu,
											   object: nil)
    ...
    open func switchContentTo(vc: UIViewController, animated: Bool = true) {
        ...
        let segue = ContentSegue(identifier: "content", source: self, destination: vc)
        segue.perform()
...
extension SlideMenuMainViewController {
